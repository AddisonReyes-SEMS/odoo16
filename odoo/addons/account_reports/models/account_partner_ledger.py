...
class PartnerLedgerCustomHandler(models.AbstractModel):
    ...
    def _custom_options_initializer(self, report, options, previous_options=None):
        ...
        elif self._context.get('print_mode') and previous_options and 'single_partner_mode' in previous_options:
        ...
        if single_partner_id:
            forced_domain = options.setdefault('forced_domain', [])
            options['forced_domain'] = forced_domain + [
                '|', ('matched_debit_ids.debit_move_id.partner_id', '=', single_partner_id),
                '|', ('matched_credit_ids.credit_move_id.partner_id', '=', single_partner_id),
